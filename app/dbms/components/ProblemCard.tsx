  ...
  return (
    <div
      className={`
        ...
        transition-all duration-200 hover:border-sky-500/30 hover:shadow-sky-500/5 hover:-translate-y-px
    ...
    >
        ...
        <div className="flex items-center gap-1">
          ...
          {problem.links.length === 1 ? (
            <a
              ...
              className="p-1.5 rounded-md text-slate-500 hover:text-sky-400 hover:bg-white/5 transition-colors"
              title="Open resource"
            >
              ↗
            </a>
        ...
        {(problem.tags || []).map((tag, i) => (
          <span
            ...
            className={`
              ...
              ${tag === "sql" ? "bg-sky-950/40 text-sky-400" : ""}
            `}
          >
            {tag.toUpperCase()}
          </span>
        ...
        {problem.links.map((link, i) => (
          <span
            ...
            className={`
              ...
              ${link.t === "web" ? "bg-sky-950/40 text-sky-400" : ""}
      ...
      <div className="border-t border-slate-800">
        <button
          ...
          className={`
            w-full flex items-center gap-2 px-4 py-2 text-xs uppercase tracking-wide text-slate-500 hover:text-sky-400
            ${note ? "text-sky-400/90" : ""}
          `}
        >
          <span>✏</span>
