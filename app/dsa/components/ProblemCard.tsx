    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          {problem.links.length === 1 ? (
            ...
            // dropdown logic can be added later (similar to your original)
            <button className="p-1.5 rounded-md text-slate-500 hover:text-emerald-400 hover:bg-white/5">
              ↗
            </button>
          )}
        </div>
        ...
        {problem.links.map((link, i) => (
          <span
            ...
            className={`
              ...
              ${link.t === "lc" ? "bg-amber-950/40 text-amber-400" : "bg-green-950/40 text-green-400"}
            `}
          >
            {link.l}
          </span>
      ...
      <div className="border-t border-slate-800">
        <button
          ...
          className={`
            w-full flex items-center gap-2 px-4 py-2 text-xs uppercase tracking-wide text-slate-500 hover:text-violet-400
            ${note ? "text-violet-400/90" : ""}
          `}
        >
          <span>✏</span>
        ...
        {isNoteOpen && (
          <div className="px-4 pb-3">
            <textarea
              ...
              placeholder="Your approach, mistakes, edge cases..."
              className="
