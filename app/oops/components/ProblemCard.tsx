  ...
  return (
    <div
      className={`
        ...
        transition-all duration-200 hover:border-violet-500/30 hover:shadow-violet-500/5 hover:-translate-y-px
        ...
        {(problem.tags || []).map((tag, i) => (
          <span
            ...
            className={`
              ...
              ${tag === "sql" ? "bg-violet-950/40 text-violet-400" : ""}
            `}
          >
            {tag.toUpperCase()}
          </span>
        ...
        {problem.links.map((link, i) => (
          <span
            ...
            className={`
              ...
              ${link.t === "web" ? "bg-violet-950/40 text-violet-400" : ""}
